...
latex_documents = [
    (master_doc, 'PyKED.tex', 'PyKED Documentation',
     'Kyle E. Niemeyer and Bryan W. Weber', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyked', 'PyKED Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyKED', 'PyKED Documentation',
     author, 'PyKED', 'One line description of project.',
     'Miscellaneous'),
]
